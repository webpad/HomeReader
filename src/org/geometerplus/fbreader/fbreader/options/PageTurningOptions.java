...
//		new ZLEnumOption<ZLView.Animation>("Scrolling", "Animation", ZLView.Animation.slide); // JK_ mark
		new ZLEnumOption<ZLView.Animation>("Scrolling", "Animation", ZLView.Animation.none); // JK_ disable Animation slide
