...
public class RootTree extends LibraryTree {
	...
	FileFirstLevelTree_AllBooks fileAllBook;
...
//		new FileFirstLevelTree_AllBooks(this);
		fileAllBook = new FileFirstLevelTree_AllBooks(this);
		new FileFirstLevelTree_AllImages(this);
		new FileFirstLevelTree_ExtSD(this);

	}

	public void fileFirstLevelTreeAllBooks(){
		fileAllBook.waitForOpeningAll();
	}
	
	public void fileFirstLevelTreeAllBooksSortByFileName(){
		fileAllBook.sortByFileName();
	}
	
	public void fileFirstLevelTreeAllBooksSearchStop(){
		fileAllBook.stop();
	}
	...
	public SearchResultsTree getSearchResultsTree() {
		return (SearchResultsTree)getSubtree(Globals.ROOT_FOUND);
	}
	...
	public SearchResultsTree createSearchResultsTree(String pattern) {
		...
		return new SearchResultsTree(this, Globals.ROOT_FOUND, pattern, position);
	}
