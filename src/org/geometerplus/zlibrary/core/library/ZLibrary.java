...
//		return new ZLStringOption("LookNFeel", "Orientation", "system");
		return new ZLStringOption("LookNFeel", "Orientation", "portrait");
	}
	public final ZLStringOption getScreenRefreshOption() {
		return new ZLStringOption("LookNFeel", "screenRefresh", Globals.pageString[5]); // Jacky 20160615 page6 is default page
	}
	protected ZLibrary() {
