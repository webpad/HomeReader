...
import com.ntx.image.SwipeBookActivity;
...
//					openInBrowser(hyperlink.Id); // hg.60 disalie external hyperlink function in reading mode
					break;
...
//					);
					...
					intent.setClass(BaseActivity, SwipeBookActivity.class);
					intent.putExtra(SwipeBookActivity.URL_KEY, url);
