...
public abstract class MenuData {
	...
	public static synchronized List<MenuNode> topLevelNodes() {
		if (ourNodes == null) {
			...
			addToplevelNode(new MenuNode.Item(ActionCode.ZOOM, R.drawable.ic_menu_zoomin));

//			addToplevelNode(new MenuNode.Item(ActionCode.INCREASE_FONT, R.drawable.ic_menu_zoomin));
//			addToplevelNode(new MenuNode.Item(ActionCode.DECREASE_FONT, R.drawable.ic_menu_zoomout));
			...
			addToplevelNode(new MenuNode.Item(ActionCode.SHOW_NAVIGATION, R.drawable.ic_menu_navigation));
			addToplevelNode(new MenuNode.Item(ActionCode.SHOW_PREFERENCES, R.drawable.ic_menu_preferences));
// Jacky 20160402		
