...
//		));
		appearanceScreen.addPreference(new ZLStringChoicePreference(
				this, appearanceScreen.Resource.getResource("screenRefresh"),
				androidLibrary.getScreenRefreshOption(), Globals.pageString));
...
// Jacky 20160315 remove perference "Prevent screen from sleeping" TODO
...
//		final Screen toastsScreen = createPreferenceScreen("toast"); // Pop-ups
