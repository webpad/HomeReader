...
public class LibraryService extends Service {
	...
	public final class LibraryImplementation extends LibraryInterface.Stub {
		...
		public int recentBooksSize() {
			return recentlyOpenedBooksSize(12);
		}
		...
		public int recentlyOpenedBooksSize(int count) {
			return myCollection.recentlyOpenedBooksSize(count);
		}
