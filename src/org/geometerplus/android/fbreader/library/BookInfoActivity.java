		...
		setupButton(R.id.book_info_button_open, "openBook", new View.OnClickListener() {
			public void onClick(View view) {
				if (myDontReloadBook) {
					...
					openBook(myBook); // fix When PDF file open , need install PDF Reader issue
    	...
    	if ( myExtension.equalsIgnoreCase("cbr")
          || myExtension.equalsIgnoreCase("cbz")) {
            try {
                ...
                mintent.setClassName(Globals.CBRCBZ_PACKAGE,
                		Globals.CBRCBZ_CLASS);
            ...
            try {
                Intent mintent = new Intent("android.intent.action.VIEW");
                mintent.setData(Uri.parse("file://" + path));
                mintent.setClassName(Globals.PDF_PACKAGE,
                		Globals.PDF_CLASS);
                mintent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK
                        | Intent.FLAG_ACTIVITY_BROUGHT_TO_FRONT);
                startActivity(mintent);
        	...
        	if (myExtension.equalsIgnoreCase("epub")
        		...
        		|| myExtension.equalsIgnoreCase("cbr")
        		|| myExtension.equalsIgnoreCase("cbz")
        		|| myExtension.equalsIgnoreCase("pdf")
        		) {
        	FBReader.openBookActivity(BookInfoActivity.this, book, null);
        }else{
