...
public class CoverManager {
	...
	public boolean trySetCoverImage(ImageView coverView, FBTree tree) {
		...
		if (coverBitmap != null) {
			...
			holder.CoverView.setBackgroundDrawable(new BitmapDrawable(holder.CoverView.getResources(), coverBitmap));
			holder.CoverView.setImageBitmap(BitmapFactory.decodeResource(holder.CoverView.getResources(), Globals.getCoverTypeTagResourceId(tree.getName())));
