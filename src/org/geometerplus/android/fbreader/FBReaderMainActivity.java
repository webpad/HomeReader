...
public abstract class FBReaderMainActivity extends Activity {	
	...
	private int ScreenBrightnessLimitPercent=7; // minimum 7%
	@Override
	...
	public void setScreenBrightnessSystem(float level) {
		...
		if ((int)(level*100)<=ScreenBrightnessLimitPercent){
			level=.07f+.01f; // jacky 20160517 Q62 Screen Brightness minimum = 7% ( int problem ,must be increase .01f )
		}
